        ...
        <div class="cf-manage-main">
            ...
            <div class="cf-card-premium">
                ...
                <div class="cf-card-body">
                    <div class="cf-empty-state-card" style="padding: 20px; border: 1px dashed #e2e8f0; border-radius: 12px; text-align: center;">
                        <p style="font-size: 13px; color: #64748b;">DNS record management is synchronized with your infrastructure account.</p>
                        <button class="cf-btn-primary-sm" style="margin-top:10px;">Add New Record</button>
                    </div>
                </div>
            </div>
...
@media (max-width: 768px) {
    .cf-dashboard-header { flex-direction: column; align-items: flex-start; text-align: left; gap: 15px; }
    ...
    .cf-title-text h1 { font-size: 20px; }
    ...
    .cf-btn-action-full, .cf-btn-danger-full { padding: 10px; font-size: 12px; }
}
